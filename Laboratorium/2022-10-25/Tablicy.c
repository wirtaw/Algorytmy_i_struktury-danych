...
// sprawdzwamy dzialanie findmax
      printf("\narr_max: %d\n", arr_max);

      int arr_min = findMin(arr, arr_size);
// sprawdzamy dzialanie findmin
      printf("arr_min: %d\n", arr_min);

// sprawdzamy dzialanie printTable
